...
verifyElementNonBlack(2, Element,NumeroJogada,AtualBoard):- (Element == 'x' -> (nl, nl, write('AVISO!!!'), nl,
	write('Nao podes escolher a peca de um oponente! Joga novamente'), nl, jogadorvscomputador(NumeroJogada,AtualBoard)); true).
...
%  Computador
verifyElementNonWhite(2, Element,NumeroJogada,AtualBoard):- (Element == 'o' -> (nl, nl, write('AVISO!!!'), nl,
	write('Nao podes escolher a peca de um oponente! Joga novamente'), nl, jogadorvscomputador(NumeroJogada,AtualBoard)); true).
...
%  Computador
verifyElementNonNone(2, Element,NumeroJogada,AtualBoard):- (Element == 'none' -> (nl, nl, write('AVISO!!!'), nl,
	write('Nao podes escolher uma peca vazia! Joga novamente'), nl, jogadorvscomputador(NumeroJogada,AtualBoard)); true).
...
verifyPieceX(2, NewElement, NumeroJogada, AtualBoard, NewElement2):- ((NewElement == 'x' -> NewElement2 = 'none');
  (NewElement == 'o' -> nl, nl, write('AVISO!!!'), nl, write('Nao podes escolher a tua peca como destino! Joga novamente'), jogadorvscomputador(NumeroJogada,AtualBoard)); NewElement2 = 'none').
...
verifyPieceO(2, NewElement, NumeroJogada, AtualBoard, NewElement2):- ((NewElement == 'o' -> NewElement2 = 'none');
  (NewElement == 'x' -> nl, nl, write('AVISO!!!'), nl, write('Nao podes escolher a tua peca como destino! Joga novamente'), jogadorvscomputador(NumeroJogada,AtualBoard)); NewElement2 = 'none').
...
%  Computador
verifyBlackNonBackMove(2, NewY,OldY , NumeroJogada, AtualBoard) :- ((NewY < OldY) -> nl, nl, write('Nao podes andar para tras! '), jogadorvscomputador(NumeroJogada,AtualBoard); true).
...
%  Computador
verifyWhiteNonBackMove(2, NewY,OldY , NumeroJogada, AtualBoard) :- ((NewY > OldY) -> nl, nl, write('Nao podes andar para tras! '), jogadorvscomputador(NumeroJogada,AtualBoard); true).
